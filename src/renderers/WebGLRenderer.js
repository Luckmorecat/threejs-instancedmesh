...
function WebGLRenderer(parameters) {
	...
	function renderObject(object, scene, camera, geometry, material, group) {
		...
		if (object.isInstancedMesh) {
			const { hipart, lopart } = object.doublePrecision(
			...
			// 	object.modelViewMatrix.elements
			// );
			object.modelViewMatrixH.fromArray(hipart);
			object.modelViewMatrixL.fromArray(lopart);
		}
	...
	function initMaterial(material, scene, object) {
		...
		// console.log("deb: parameters", parameters);
	...
	function setProgram(camera, scene, material, object) {
		...
		if (object.isInstancedMesh) {
			p_uniforms.setValue(_gl, "modelViewMatrixH", object.modelViewMatrixH);
			p_uniforms.setValue(_gl, "modelViewMatrixL", object.modelViewMatrixL);
		}
